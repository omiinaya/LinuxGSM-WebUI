...
export const LINUXGSM_COMMANDS: Command[] = [
  ...
  },
  {
    id: "postdetails",
    name: "Post Details",
    description: "Share server details (hide sensitive info)",
    short: "pd",
    long: "postdetails",
    category: "info",
    requiresServer: true,
  ...
  },
  {
    id: "force-update",
    name: "Force Update",
    description: "Force update and restart",
    short: "fu",
    long: "force-update",
    category: "maintenance",
    requiresServer: true,
  ...
  },
  {
    ...
    description: "Update LinuxGSM scripts",
    short: "ul",
    long: "update-lgsm",
    category: "maintenance",
    requiresServer: true,
  ...
  // Install Commands
  {
    id: "install",
    name: "Install",
    description: "Install game server",
    short: "i",
    long: "install",
    category: "install",
  },
  {
    id: "auto-install",
    name: "Auto Install",
    description: "Auto install (no prompts)",
    short: "ai",
    long: "auto-install",
    category: "install",
  },
  ...
  },
  {
    id: "skeleton",
    name: "Skeleton",
    description: "Create skeleton directory",
    short: "sk",
    long: "skeleton",
    category: "developer",
    requiresServer: true,
